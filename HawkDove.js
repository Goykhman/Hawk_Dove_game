...
var HawkDove=function(initial_hawk_ratio,population_size,initial_fitness,
	...
	this.one_encounter=function(bird_1_index,bird_2_index){
		...
		//	var r=Math.random();
		//	if(r<0.5){// bird_1 wins
		//		this.population[bird_1_index].fitness+=this.value;
		//		this.population[bird_2_index].fitness-=this.cost;
		//	}
		//	else{// bird_2 wins
		//		this.population[bird_2_index].fitness+=this.value;
		//		this.population[bird_1_index].fitness-=this.cost;
		//	}
		}
...
Else the ESS is value/cost fraction of hawks.
...
//console.log(HawkDove.binary_search([1,3,5,6,7,8,9],0,6,9.1))
